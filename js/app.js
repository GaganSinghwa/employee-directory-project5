...
function getEmployeeInfo(data) {
	...
	$.each (data.results, function (i, profile) {
		...
		detailedHTML += '<a href=#><img class="left-arrow" src="images/lightbox-btn-prev.gif"></a>';
		detailedHTML += '<a href=#><img class="right-arrow" src="images/lightbox-btn-next.gif"></a>';
